...
#### Material:
# R sources: bootstrap_coin.R, analysis_coin.R, bootstrap_coin_nested.R, analysis_coin_nested.R, bootstrap_binary_samplesize.R, analysis_binary_samplesize.R, bootstrap_binary_dispersion.R, analysis_binary_dispersion.R
...
The bootstrap analysis takes some time to run, especially for results on the crowd size where I generate 1000 bootstrap samples for each crowd size. Thus, the material is organized such that the results can be reproduced without replicating the bootstrap analysis. 
