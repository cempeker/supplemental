########### Bootstrap Analysis, Coin Flips data, Nested structure.
...
load('bootstrap_coin_nested.RData')
...
# Average RMSE plots
plotError(coin_err2, 'SOA') 
#plotError(coin_err2, 'SOA2')

# Bootstrap error difference (confidence interval) plots
plotErrorDiff(diff_log,'logdiff') 
#plotErrorDiff(diff_log2,'logdiff') 
